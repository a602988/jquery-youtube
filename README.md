...
$.fullscreenElement()			// returns the fullscreen (javascript) element, or returns null
// the fullscreen-ed element will have a ```ytplayer-fullscreen``` class while in fullscreen mode
